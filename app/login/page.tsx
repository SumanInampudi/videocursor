...
export default async function LoginPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  return (
    <div className="relative flex min-h-[100dvh] items-center justify-center bg-surface px-4">
      <LoginThemeToggle />
      <div className="auth-panel">
        ...
        <div className="mt-6 rounded-xl border border-brand-200/60 bg-brand-50/50 p-4 text-xs text-charcoal-muted dark:border-brand-700/35 dark:bg-brand-900/20">
          <p className="font-semibold text-brand-900 dark:text-brand-200">Default accounts (after seed)</p>
