  ...
  return (
    <ToastProvider>
      <div className="min-h-[100dvh] bg-surface text-charcoal">
        <header className="safe-area-top relative flex flex-wrap items-center justify-between gap-3 border-b border-teal-200/60 bg-white px-4 py-3 shadow-header">
