...
import { hasRecipeImage, recipeThumbnailInitial } from "@/lib/recipe-image";

export type RecipeThumbnailSize = "xs" | "sm" | "md" | "lg" | "tile";

const BOX: Record<Exclude<RecipeThumbnailSize, "tile">, string> = {
...
export function RecipeThumbnail({
  ...
  const showImage = hasRecipeImage(imageUrl);
  const boxClass =
    size === "tile"
