...
export function ProductMenuTile({
  name,
  price,
  imageUrl,
  onClick,
  ...
  if (variant === "order") {
    return (
      ...
      >
        <ProductThumbnail name={name} imageUrl={imageUrl} size="md" />
  ...
  return (
    ...
    >
      <div className="relative h-16 w-full shrink-0 md:h-20">
        <ProductThumbnail name={name} imageUrl={imageUrl} size="tile" />
      </div>
